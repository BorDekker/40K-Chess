...
public:
    ...
    void setBPawnTexture(const sf::Texture& texture);
    void setBKingTexture(const sf::Texture& texture);
    void setBQueenTexture(const sf::Texture& texture);
    void setBRookTexture(const sf::Texture& texture);
    void setBKnightTexture(const sf::Texture& texture);
    void setBBishopTexture(const sf::Texture& texture);
